...
export META_INSTALLER_CONFIG_FILE="/vagrant/meta-installer.conf"
source $META_INSTALLER_CONFIG_FILE

# Meta Installer that installs the vagrant bootstrapper

adduser $META_INSTALLER_PROJECT_USER
...
vagrant box add $DEFAULT_VAGRANT_BOX $DEFAULT_VAGRANT_BOX_URI
